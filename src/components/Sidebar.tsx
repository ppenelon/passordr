    ...
    <div className={classNames("sidebar", { opened: sidebarOpened })}>
      ...
      <div className="sidebar-body">
        <div className="sidebar-header">
          ...
          <button
            className="sidebar-header-close action-button"
            ...
            <li>
              ...
              <ul>
                ...
                <li>
                  <button
                    className="action-button"
                    onClick={() => openModal(ModalType.Backup)}
                  >
                    {/* Font Awesome fa-solid fa-floppy-disk */}
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 448 512"
                    >
        ...
        <div className="sidebar-footer">
          <ul>
            <li>
              <button
                className="action-button"
                onClick={() => openModal(ModalType.Parameters)}
              >
