...
const Sidebar: React.FC = () => {
  ...
  const renameCurrentVault = useVaultsManagerStore(state => state.renameCurrentVault);

  function promptRenameVault() {
    const newVaultName = prompt('Please enter new vault name', currentVault.name);
    if(newVaultName) {
  ...
  return (
    <div className={classNames("sidebar", { opened: sidebarOpened })}>
      <div className="sidebar-background" onClick={e => closeSidebar()} />
      <div className="sidebar-body">
        <div className="sidebar-header">
          ...
          <button className="sidebar-header-close action-button" onClick={e => closeSidebar()}>
            {/* Font Awesome fa-solid fa-square-caret-left */}
          ...
          <ul>
            <li>
              ...
              <ul>
                ...
                <li>
                  <button className="action-button" onClick={() => openModal(ModalType.History)}>
        ...
        <div className="sidebar-footer">
          <ul>
            <li>
              <button className="action-button">
                {/* Font Awesome fa-solid fa-gears */}
